...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/05/2024 às 15:03
...
(36, 'Carteira', 0, 1501.01, '6d8b97', 158, 0),
(37, 'Nossa Conta', 1, -17850, '6d8b97', 158, 0),
...
(52, 'Bradesco', 0, 11.96, '6d8b97', 158, 0);
...
(62, 'Remédio', 8987, 0, '6d8b97', 158, 13, 4, 2024, 113, 0, NULL, 36),
...
(72, 'Ajuste de Saldo', 0.219992, 1, '6d8b97', 158, 17, 4, 2024, 141, 1, NULL, 39),
...
(5, 'Comprar Carro', 25000, 7000, 0, '2025-06-30', '6d8b97', 4, 16),
(6, 'Comprar Casa', 150000, 50000, 0, '2025-08-01', '6d8b97', 5, 27),
(7, 'Comprar celular', 1500, 1000, 0, '2024-05-29', '6d8b97', 16, 39),
(8, 'Comprar notebook', 4000, 2600, 0, '2024-05-27', '6d8b97', 6, 20),
(9, 'Arrumar alguma coisa', 500, 450, 0, '2024-05-27', '6d8b97', 16, 36),
(10, 'Algo mais pra frente', 15000, 10000, 0, '2026-12-04', '6d8b97', 17, 35),
(12, 'Teste curto', 500, 450, 0, '2024-05-14', '6d8b97', 9, 10),
(13, 'Teste Longo', 5800, 3000, 0, '2026-01-31', '6d8b97', 2, 21);
...
(158, 'Admin', 'tester@teste.com', '15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225', '6d8b97', 'parceiro@qualquer.com', '2024-03-21 19:43:33', '2024-05-18 01:31:27'),
(159, 'Parceiro', 'parceiro@qualquer.com', '15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225', '6d8b97', '', '2024-03-21 19:48:08', '2024-04-26 20:42:46');
...
--
ALTER TABLE `usuario`
  MODIFY `id` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
...
--
ALTER TABLE `aporte_objetivo`
  ADD CONSTRAINT `fk_aporte_objetivo` FOREIGN KEY (`objetivo`) REFERENCES `objetivo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
